...
| [yeti](https://github.com/yeti-platform/yeti) | Your Everyday Threat Intelligence | 1.9k ⭐ | Python | 2 weeks ago | 🟢 |
| [Cortex](https://github.com/TheHive-Project/Cortex) | Cortex: a Powerful Observable Analysis and Active Response Engine | 1.4k ⭐ | Scala | 6 months ago | 🟡 |
...
| [docker-bench-security](https://github.com/docker/docker-bench-security) | The Docker Bench for Security is a script that checks for dozens of common best-... | 9.4k ⭐ | Shell | 7 months ago | 🟢 |
| [anchore-engine](https://github.com/anchore/anchore-engine) | A service that analyzes docker images and scans for vulnerabilities | 1.6k ⭐ | Python | 2 years ago | 🔴 |
...
| [pacu](https://github.com/RhinoSecurityLabs/pacu) | The AWS exploitation framework, designed for testing the security of Amazon Web ... | 4.7k ⭐ | Python | 2 months ago | 🟢 |
| [cloudsploit](https://github.com/aquasecurity/cloudsploit) | Cloud Security Posture Management (CSPM) | 3.5k ⭐ | JavaScript | 3 weeks ago | 🟢 |
| [Scout2](https://github.com/nccgroup/Scout2) | Security auditing tool for AWS environments | 1.7k ⭐ | Python | 6 years ago | 🟡 |
...
| [grr](https://github.com/google/grr) | GRR Rapid Response: remote live forensics for incident response | 4.9k ⭐ | Python | 3 days ago | 🟢 |
| [autopsy](https://github.com/sleuthkit/autopsy) | Autopsy® is a digital forensics platform and graphical interface to The Sleuth K... | 2.7k ⭐ | Java | 1 week ago | 🟢 |
...
| [cryptography](https://github.com/pyca/cryptography) | cryptography is a package designed to expose cryptographic primitives and recipe... | 7.0k ⭐ | Python | Today | 🟢 |
| [boringssl](https://github.com/google/boringssl) | Mirror of BoringSSL | 1.9k ⭐ | C++ | 1 day ago | 🟢 |
